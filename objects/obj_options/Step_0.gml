...
if(option_x < -200) && (option_committed != -1)
{
	...
	{
		case 2: instance_create_layer(0,0,"Instances",obj_control); instance_destroy(self); break;
		case 1: instance_create_layer(0,0,"Instances",obj_video); instance_destroy(self); break;
