...
if(option_x < -100) && (option_committed != -1)
{
	switch (option_committed)
	{
		case 2: default: scr_Transition(TRANS_MODE.GOTO,r_Menu); break; //Should go to Control Menu
		case 1: scr_Transition(TRANS_MODE.GOTO,r_Menu); break; //Should go to Video Menu
